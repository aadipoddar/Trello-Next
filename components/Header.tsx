    ...
    <header>
      <div className='flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl'>
        ...
        <div className='flex items-center space-x-5 flex-1 justify-end'>
          ...
          {/* Avatar */}
          <Avatar name='Aadi Poddar' round size='50' color='#0055D1'/>
      ...
      <div className='flex items-center justify-center px-5 py-2 md:py-5'>
          <p className='flex items-center p-5 text-sm font-light pr-5
              ...
              {suggestion && !loading ? suggestion : 'Chat GPT is Summarizing your tasks for the day...'}
          </p>
      </div>
